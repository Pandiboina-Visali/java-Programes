...
cbill=tu*1.45f+((50*1.45f)+(tu-50)*2.30f)+((50*1.45f)+50*3.20f+(tu-100)*3.56f)+((50*1.45f)+(50*3.20f)+(100*3.56f)+(tu-200*4.87f))+((50*1.45f)+50*3.20f+200*3.56f+tu-300*5.76f);
...
System.out.println("The Customer Lst Month Reading:"+lmr);
